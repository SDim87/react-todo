...
const acronim = () => {
  ...
  switch (curArm) {
    case 'director':
      return 'widget_requests_main_services_count_director_graph'
    default:
      break
  }
}

const AppBasicServices = ({ identificator, curWidgetData, }) => {
...
export default connect(mapStateToProps)(AppBasicServices)
