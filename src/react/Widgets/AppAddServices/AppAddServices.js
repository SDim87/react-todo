...
const acronim = () => {
  ...
  switch (curArm) {
    case 'director':
      return 'widget_objects_requests_extra_services_count_director_graph'
    default:
      break
  }
}

const AppAddServices = ({ identificator, curWidgetData, }) => {
...
export default connect(mapStateToProps)(AppAddServices)
