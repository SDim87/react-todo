  ...
  return (
    <OutsideClickHandler onOutsideClick={() => setOpen('')}>
      <div className="filter-second">
        <div
          className={`filter-second__input ${classOpened}`}
          onClick={() => setOpen(!classOpened ? 'is-opened' : '')}
        >
          <input
        ...
        <div className="filter-second__dropdown">
          <div className="filter-second__group">
            ...
            <label className="filter-second__label filter-second__label_all" htmlFor="allChecked">
              Выбрать все
            </label>
          </div>
          ...
          <ExpandBlock
            ...
            setExpandBlockId={setExpandBlockId}
          />
          <ExpandBlock
            id={2}
            {...props}
